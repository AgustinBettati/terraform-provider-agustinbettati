...
# Data Source: mongodbatlas_flex_cluster_api_v1

`mongodbatlas_flex_cluster_api_v1` describes a cluster.
...
data "mongodbatlas_flex_cluster_api_v1" "example-clusters" {
  project_id = var.project_id
}
