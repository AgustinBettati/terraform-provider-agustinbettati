---
page_title: "mongodbatlas_flex_clusters_api_v1"
subcategory: "Flex Cluster"
---

# Data Source: mongodbatlas_flex_clusters_api_v1

`mongodbatlas_flex_clusters_api_v1` returns all clusters in a project.
...
data "mongodbatlas_flex_clusters_api_v1" "example-clusters" {
  project_id = var.project_id
}
