---
page_title: "mongodbatlas_flex_cluster_api_v2"
subcategory: "Flex Cluster"
---

# Data Source: mongodbatlas_flex_cluster_api_v2

`mongodbatlas_flex_cluster_api_v2` describes a cluster.
...
data "mongodbatlas_clusters_api_v2" "example-clusters" {
  project_id = var.project_id
}
