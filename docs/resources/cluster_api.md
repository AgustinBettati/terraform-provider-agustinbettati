...
```terraform
resource "mongodbatlas_cluster_api" "example-cluster" {
...
data "mongodbatlas_cluster_api" "example-cluster" {
  project_id = var.project_id
  name       = mongodbatlas_cluster.example-cluster.name
}

data "mongodbatlas_clusters_api" "example-clusters" {
  project_id = var.project_id
}

output "mongodbatlas_cluster_api" {
