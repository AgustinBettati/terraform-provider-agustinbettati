# Resource: mongodbatlas_cluster_api_v2

`mongodbatlas_cluster_api_v2` provides a Cluster resource. The resource lets you create, update, delete and import a cluster.
