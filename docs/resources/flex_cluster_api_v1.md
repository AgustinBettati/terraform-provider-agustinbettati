...
---
# Resource: mongodbatlas_flex_cluster_api_v1

`mongodbatlas_flex_cluster_api_v1` provides a Cluster resource. The resource lets you create, update, delete and import a cluster.


## Example Usages

```terraform
resource "mongodbatlas_flex_cluster_api_v1" "example-cluster" {
...
data "mongodbatlas_flex_cluster_api_v1" "example-cluster" {
  project_id = var.project_id
...
output "mongodbatlas_flex_cluster_api_v1" {
